  ...
  data() {
    return {
      sidebarLinks: [
        ...
        {
          title: 'cruds.pouting.title',
          icon: 'table_view',
          path: { name: 'poutings.index' },
          gate: 'pouting_access'
        },
        {
          title: 'cruds.setoran.title',
          icon: 'table_view',
          path: { name: 'setorans.index' },
          gate: 'setoran_access'
        },
        {
          title: 'cruds.cashflow.title',
          icon: 'table_view',
          path: { name: 'cashflows.index' },
          gate: 'cashflow_access'
        }
      ]
    }
  }
